<template>
    <ClientOnly>
        <div class="home">
            ...
            <div class="intro">
                <h2 class="value">手机应用软件开发能给企业带来哪些价值</h2>
                <ul>
                    <li><img src="/svg/li_style.svg" alt="">手机应用软件开发可以帮助企业实现精准营销。APP将企业的最新信息，比如公司最近的新产品上市或促销活动等信息快速精准的传达给目标客户。</li>
                    <li><img src="/svg/li_style.svg" alt="">可以通过手机APP随时随地传达信息给客户，不时间跟空间等原因受阻。</li>
                    <li><img src="/svg/li_style.svg" alt="">提高用户的粘度，留住新老客户，让他们成为中最好的口碑传播者。</li>
                    <li><img src="/svg/li_style.svg" alt="">企业用最低的广告成本，获得最佳的宣传效果传统的广告方式相比，手机APP广告无需按点击和次数付费，其图文并茂、形象生动的广告表现形式论是费用还是效果方面都比传统的广告更胜一筹。</li>
                    <li><img src="/svg/li_style.svg" alt="">服务于现有客户，提升客户的满意度，并促成二次消费。</li>
                </ul>
                <h2 class="cost">开发一个iOSAPP需要多少钱</h2>
                <div class="desc">
                    要说到开发一款APP多少钱？这是许多需要制作APP客户端的企业都会想要知道的问题答案，就APP开发的工作内容来看，APP报价都受到多方面的因素影响，所以相应的苹果APP的开发价格当然也是受到很多因素影响的。
                </div>
                <ul>
                    <li>
                        <img src="/svg/li_style.svg" alt="">
                    ...
                    <li>
                        ...
                        <div>
                            目前比较主流的APP应用开发就是苹果APP开发和安卓APP开发，但是因为苹果APP开发所使用到的Objective-C语言是比较难学习的，在APP开发上也会遇到非常多的难题，所以相较于简单易学的Java语言开发的安卓APP软件，在报价上就会高出很多。因此，苹果IOS
                            APP开发的报价通常都是高于安卓APP报价。</div>
                    </li>
                </ul>
